...
<head>
	...
	<script>
		$(document).ready(function(){
			...
			$.validator.addMethod("doCustomValidation",function(value,element){
				var format = /^[a-zA-Z0-9]+$/;
				return this.optional(element)|| format.test(value);
			},"only character and number");
	...
	<form id="inputForm" action="${ctx}/register" method="post" class="form-horizontal">
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="password" id="password" name="password" class="input-large required"/><br>
				</div>
			</div>
			<div class="control-group">
